...
一个 Claude Code / OpenClaw / Codex / Cursor / VS Code Copilot 通用的 Agent Skill，基于微软 [MarkItDown](https://github.com/microsoft/markitdown)（131k+ Stars），将任何文件格式一键转换为 Markdown。
...
Agent 会自动触发 `markitdown-converter` 来处理任务。
